...
public final class JSAddConstantRightNumberNodeGen extends JSAddConstantRightNumberNode implements Provider {
    ...
    public Object execute(Object operandNodeValue) {
        ...
        if ((state & 0b100000) != 0 /* is-active doStringNumber(CharSequence, String, JSConcatStringsNode) */ && JSTypesGen.isImplicitCharSequence((state & 0b111100000000000) >>> 11 /* extract-implicit-active 0:CharSequence */, operandNodeValue)) {
    ...
    private Object execute_generic2(VirtualFrame frameValue, int state) {
        ...
        if ((state & 0b100000) != 0 /* is-active doStringNumber(CharSequence, String, JSConcatStringsNode) */ && JSTypesGen.isImplicitCharSequence((state & 0b111100000000000) >>> 11 /* extract-implicit-active 0:CharSequence */, operandNodeValue_)) {
    ...
    private Object executeAndSpecialize(Object operandNodeValue) {
        ...
        try {
            ...
            if (((exclude & 0b10000)) == 0 /* is-not-excluded doStringNumber(CharSequence, String, JSConcatStringsNode) */) {
                ...
                if ((charSequenceCast0 = JSTypesGen.specializeImplicitCharSequence(operandNodeValue)) != 0) {
                    ...
                    this.state_ = state = state | 0b100000 /* add-active doStringNumber(CharSequence, String, JSConcatStringsNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doStringNumber(operandNodeValue_, this.stringNumber_rightString_, this.stringNumber_createLazyString_);
                }
            ...
            this.exclude_ = exclude = exclude | 0b11001 /* add-excluded doInt(int), doDouble(double), doStringNumber(CharSequence, String, JSConcatStringsNode) */;
            state = state & 0xffffffcd /* remove-active doInt(int), doDouble(double), doStringNumber(CharSequence, String, JSConcatStringsNode) */;
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "doStringNumber";
        if ((state & 0b100000) != 0 /* is-active doStringNumber(CharSequence, String, JSConcatStringsNode) */) {
            s[1] = (byte)0b01 /* active */;
            ArrayList<Object> cached = new ArrayList<>();
            cached.add(Arrays.asList(this.stringNumber_rightString_, this.stringNumber_createLazyString_));
            s[2] = cached;
        } else if ((exclude & 0b10000) != 0 /* is-excluded doStringNumber(CharSequence, String, JSConcatStringsNode) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
