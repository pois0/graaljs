...
final class JSArgumentsObjectGen {
    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private InteropLibraryExports() {
            super(InteropLibrary.class, JSArgumentsObject.class, false);
        }
        ...
        private static final class Cached extends InteropLibrary {
            ...
            Cached(Object originalReceiver) {
                JSArgumentsObject receiver = ((JSArgumentsObject) originalReceiver) ;
            ...
            public Object readArrayElement(Object arg0Value_, long arg1Value) throws UnsupportedMessageException, InvalidArrayIndexException {
                ...
                JSArgumentsObject arg0Value = CompilerDirectives.castExact(arg0Value_, receiverClass_);
                int state = state_;
                if ((state & 0b10000000000) != 0 /* is-active readArrayElement(JSArgumentsObject, long, LanguageReference<JavaScriptLanguage>, ReadElementNode, ExportValueNode, InteropLibrary) */) {
                    {
                        LanguageReference<JavaScriptLanguage> javaScriptLanguageReference__ = this.javaScriptLanguageReference_;
                ...
                try {
                    {
                        ...
                        this.state_ = state = state | 0b10000000000 /* add-active readArrayElement(JSArgumentsObject, long, LanguageReference<JavaScriptLanguage>, ReadElementNode, ExportValueNode, InteropLibrary) */;
                        lock.unlock();
                        hasLock = false;
                        return arg0Value.readArrayElement(arg1Value, readArrayElementNode__languageRef__, this.readArrayElementNode__readNode_, this.readArrayElementNode__exportNode_, readArrayElementNode__thisLibrary__);
                    }
        ...
        private static final class Uncached extends InteropLibrary {
            ...
            Uncached(Object receiver) {
                this.receiverClass_ = ((JSArgumentsObject) receiver).getClass();
            }
