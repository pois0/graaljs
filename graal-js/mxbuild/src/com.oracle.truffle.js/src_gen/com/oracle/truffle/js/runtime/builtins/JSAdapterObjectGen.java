...
final class JSAdapterObjectGen {
    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private InteropLibraryExports() {
            super(InteropLibrary.class, JSAdapterObject.class, false);
        }
        ...
        private static final class Cached extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert !(receiver instanceof JSAdapterObject) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
                return receiver instanceof JSAdapterObject;
            }
            ...
            public Object getMembers(Object arg0Value_, boolean arg1Value) throws UnsupportedMessageException {
                ...
                JSAdapterObject arg0Value = ((JSAdapterObject) arg0Value_);
                int state = state_;
            ...
            public boolean hasMembers(Object receiver) {
                ...
                assert assertAdopted();
                return (((JSAdapterObject) receiver)).hasMembers();
            }
            ...
            public void removeMember(Object receiver, String member) throws UnsupportedMessageException, UnknownIdentifierException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                (((JSAdapterObject) receiver)).removeMember(member);
                return;
            }
            ...
            public boolean hasLanguage(Object receiver) {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSAdapterObject) receiver)).hasLanguage();
            }
            ...
            public Class<? extends TruffleLanguage<?>> getLanguage(Object receiver) throws UnsupportedMessageException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSAdapterObject) receiver)).getLanguage();
            }
            ...
            public Object toDisplayString(Object receiver, boolean allowSideEffects) {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSAdapterObject) receiver)).toDisplayString(allowSideEffects);
            }
