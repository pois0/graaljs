...
public final class JSPrepareThisNodeGen extends JSPrepareThisNode implements Provider {
    ...
    public Object execute(VirtualFrame frameValue, Object operandNodeValue) {
        int state = state_;
        if ((state & 0b11) != 0 /* is-active doJSObject(Object) || doJSObjectCached(Object, Class<>) */) {
            ...
            if ((state & 0b10) != 0 /* is-active doJSObjectCached(Object, Class<>) */) {
        ...
        if ((state & 0b100) != 0 /* is-active doJSObject(DynamicObject) */ && JSTypes.isDynamicObject(operandNodeValue)) {
        ...
        if ((state & 0b100000) != 0 /* is-active doString(String) */ && JSTypesGen.isImplicitString((state & 0x1e000) >>> 13 /* extract-implicit-active 0:String */, operandNodeValue)) {
            String operandNodeValue_ = JSTypesGen.asImplicitString((state & 0x1e000) >>> 13 /* extract-implicit-active 0:String */, operandNodeValue);
        ...
        if ((state & 0b10000000) != 0 /* is-active doDouble(double) */ && JSTypesGen.isImplicitDouble((state & 0x1e0000) >>> 17 /* extract-implicit-active 0:double */, operandNodeValue)) {
            double operandNodeValue_ = JSTypesGen.asImplicitDouble((state & 0x1e0000) >>> 17 /* extract-implicit-active 0:double */, operandNodeValue);
    ...
    public Object execute(VirtualFrame frameValue) {
        int state = state_;
        if ((state & 0b1111111110111) == 0 /* only-active doBoolean(boolean) */ && (state & 0b1111111111111) != 0  /* is-not doJSObject(Object) && doJSObjectCached(Object, Class<>) && doJSObject(DynamicObject) && doBoolean(boolean) && doJSLazyString(JSLazyString) && doString(String) && doInt(int) && doDouble(double) && doBigInt(BigInt) && doNumber(Object) && doSymbol(Symbol) && doForeignObject(Object, InteropLibrary) && doForeignObject(Object, InteropLibrary) */) {
            return execute_boolean0(frameValue, state);
        } else if ((state & 0b1111110111111) == 0 /* only-active doInt(int) */ && (state & 0b1111111111111) != 0  /* is-not doJSObject(Object) && doJSObjectCached(Object, Class<>) && doJSObject(DynamicObject) && doBoolean(boolean) && doJSLazyString(JSLazyString) && doString(String) && doInt(int) && doDouble(double) && doBigInt(BigInt) && doNumber(Object) && doSymbol(Symbol) && doForeignObject(Object, InteropLibrary) && doForeignObject(Object, InteropLibrary) */) {
            return execute_int1(frameValue, state);
        } else if ((state & 0b1111101111111) == 0 /* only-active doDouble(double) */ && (state & 0b1111111111111) != 0  /* is-not doJSObject(Object) && doJSObjectCached(Object, Class<>) && doJSObject(DynamicObject) && doBoolean(boolean) && doJSLazyString(JSLazyString) && doString(String) && doInt(int) && doDouble(double) && doBigInt(BigInt) && doNumber(Object) && doSymbol(Symbol) && doForeignObject(Object, InteropLibrary) && doForeignObject(Object, InteropLibrary) */) {
    ...
    private Object execute_double2(VirtualFrame frameValue, int state) {
        ...
        try {
            if ((state & 0x1c0000) == 0 /* only-active 0:double */ && (state & 0b1111111111111) != 0  /* is-not doJSObject(Object) && doJSObjectCached(Object, Class<>) && doJSObject(DynamicObject) && doBoolean(boolean) && doJSLazyString(JSLazyString) && doString(String) && doInt(int) && doDouble(double) && doBigInt(BigInt) && doNumber(Object) && doSymbol(Symbol) && doForeignObject(Object, InteropLibrary) && doForeignObject(Object, InteropLibrary) */) {
            ...
            } else if ((state & 0x1a0000) == 0 /* only-active 0:double */ && (state & 0b1111111111111) != 0  /* is-not doJSObject(Object) && doJSObjectCached(Object, Class<>) && doJSObject(DynamicObject) && doBoolean(boolean) && doJSLazyString(JSLazyString) && doString(String) && doInt(int) && doDouble(double) && doBigInt(BigInt) && doNumber(Object) && doSymbol(Symbol) && doForeignObject(Object, InteropLibrary) && doForeignObject(Object, InteropLibrary) */) {
                operandNodeValue_int = super.operandNode.executeInt(frameValue);
                operandNodeValue_ = JSTypes.intToDouble(operandNodeValue_int);
            } else if ((state & 0x160000) == 0 /* only-active 0:double */ && (state & 0b1111111111111) != 0  /* is-not doJSObject(Object) && doJSObjectCached(Object, Class<>) && doJSObject(DynamicObject) && doBoolean(boolean) && doJSLazyString(JSLazyString) && doString(String) && doInt(int) && doDouble(double) && doBigInt(BigInt) && doNumber(Object) && doSymbol(Symbol) && doForeignObject(Object, InteropLibrary) && doForeignObject(Object, InteropLibrary) */) {
                ...
                operandNodeValue_ = JSTypesGen.expectImplicitDouble((state & 0x1e0000) >>> 17 /* extract-implicit-active 0:double */, operandNodeValue__);
            }
        } catch (UnexpectedResultException ex) {
            return executeAndSpecialize(ex.getResult());
        }
    ...
    @TruffleBoundary
    private Object foreignObject1Boundary0(int state, Object operandNodeValue_) {
        EncapsulatingNodeReference encapsulating_ = EncapsulatingNodeReference.getCurrent();
        Node prev_ = encapsulating_.set(this);
        try {
            {
    ...
    private Object execute_generic3(VirtualFrame frameValue, int state) {
        ...
        if ((state & 0b100) != 0 /* is-active doJSObject(DynamicObject) */ && JSTypes.isDynamicObject(operandNodeValue_)) {
        ...
        if ((state & 0b100000) != 0 /* is-active doString(String) */ && JSTypesGen.isImplicitString((state & 0x1e000) >>> 13 /* extract-implicit-active 0:String */, operandNodeValue_)) {
            String operandNodeValue__ = JSTypesGen.asImplicitString((state & 0x1e000) >>> 13 /* extract-implicit-active 0:String */, operandNodeValue_);
        ...
        if ((state & 0b10000000) != 0 /* is-active doDouble(double) */ && JSTypesGen.isImplicitDouble((state & 0x1e0000) >>> 17 /* extract-implicit-active 0:double */, operandNodeValue_)) {
            double operandNodeValue__ = JSTypesGen.asImplicitDouble((state & 0x1e0000) >>> 17 /* extract-implicit-active 0:double */, operandNodeValue_);
        ...
        try {
                ...
                if (!JSObjectCached_duplicateFound_) {
                    {
                        ...
                        if ((jSObjectCached_cachedClass__ != null) && (jSObjectCached_cachedClass__.isInstance(operandNodeValue)) && ((state & 0b10)) == 0 /* is-not-active doJSObjectCached(Object, Class<>) */) {
                            this.jSObjectCached_cachedClass_ = jSObjectCached_cachedClass__;
                            this.state_ = state = state | 0b10 /* add-active doJSObjectCached(Object, Class<>) */;
                            JSObjectCached_duplicateFound_ = true;
                        }
                    }
                }
            ...
            if (JSTypes.isDynamicObject(operandNodeValue)) {
                ...
                if ((JSGuards.isJSObject(operandNodeValue_))) {
                    ...
                    state = state & 0xfffffffd /* remove-active doJSObjectCached(Object, Class<>) */;
            ...
            }
            {
                ...
                if ((stringCast0 = JSTypesGen.specializeImplicitString(operandNodeValue)) != 0) {
                    ...
                    state = (state | (stringCast0 << 13) /* set-implicit-active 0:String */);
            ...
            }
            {
                ...
                if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(operandNodeValue)) != 0) {
                    ...
                    state = (state | (doubleCast0 << 17) /* set-implicit-active 0:double */);
            ...
            if (((exclude & 0b10)) == 0 /* is-not-excluded doForeignObject(Object, InteropLibrary) */) {
                int count12_ = 0;
                ForeignObject0Data s12_ = this.foreignObject0_cache;
                if ((state & 0b100000000000) != 0 /* is-active doForeignObject(Object, InteropLibrary) */) {
                    while (s12_ != null) {
                ...
                if (s12_ == null) {
                    if ((JSGuards.isForeignObject(operandNodeValue)) && count12_ < (5)) {
                ...
                InteropLibrary foreignObject1_interop__ = null;
                {
                    ...
                    try {
                        if ((JSGuards.isForeignObject(operandNodeValue))) {
                            ...
                            this.exclude_ = exclude = exclude | 0b10 /* add-excluded doForeignObject(Object, InteropLibrary) */;
    ...
    public Introspection getIntrospectionData() {
        ...
        if ((state & 0b100000000000) != 0 /* is-active doForeignObject(Object, InteropLibrary) */) {
            ...
            s[2] = cached;
        } else if ((exclude & 0b10) != 0 /* is-excluded doForeignObject(Object, InteropLibrary) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
