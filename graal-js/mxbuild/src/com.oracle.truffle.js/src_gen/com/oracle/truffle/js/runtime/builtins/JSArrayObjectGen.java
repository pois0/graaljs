    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private static final class Cached extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert !(receiver instanceof JSArrayObject) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
            ...
            public Object getMembers(Object arg0Value_, boolean arg1Value) throws UnsupportedMessageException {
                ...
                int state = state_;
                if ((state & 0b11) != 0 /* is-active fastArray(JSArrayObject, boolean) || slowArray(JSArrayObject, boolean) */) {
                    if ((state & 0b1) != 0 /* is-active fastArray(JSArrayObject, boolean) */) {
                        if ((JSGuards.isJSFastArray(arg0Value))) {
                            return GetMembers.fastArray(arg0Value, arg1Value);
                        }
                    }
                    if ((state & 0b10) != 0 /* is-active slowArray(JSArrayObject, boolean) */) {
                        if ((!(JSGuards.isJSFastArray(arg0Value)))) {
            ...
            private Object getMembersAndSpecialize(JSArrayObject arg0Value, boolean arg1Value) {
                int state = state_;
                if ((JSGuards.isJSFastArray(arg0Value))) {
                    this.state_ = state = state | 0b1 /* add-active fastArray(JSArrayObject, boolean) */;
                    return GetMembers.fastArray(arg0Value, arg1Value);
                }
                if ((!(JSGuards.isJSFastArray(arg0Value)))) {
                    this.state_ = state = state | 0b10 /* add-active slowArray(JSArrayObject, boolean) */;
                    return GetMembers.slowArray(arg0Value, arg1Value);
                }
            ...
            public Object readArrayElement(Object arg0Value_, long arg1Value) throws UnsupportedMessageException, InvalidArrayIndexException {
                ...
                JSArrayObject arg0Value = ((JSArrayObject) arg0Value_);
                int state = state_;
                if ((state & 0b1000000000000) != 0 /* is-active readArrayElement(JSArrayObject, long, LanguageReference<JavaScriptLanguage>, ReadElementNode, ExportValueNode, InteropLibrary) */) {
                    {
                        LanguageReference<JavaScriptLanguage> javaScriptLanguageReference__ = this.javaScriptLanguageReference_;
                ...
                try {
                    {
                        ...
                        this.state_ = state = state | 0b1000000000000 /* add-active readArrayElement(JSArrayObject, long, LanguageReference<JavaScriptLanguage>, ReadElementNode, ExportValueNode, InteropLibrary) */;
                        lock.unlock();
                        hasLock = false;
                        return arg0Value.readArrayElement(arg1Value, readArrayElementNode__languageRef__, this.readArrayElementNode__readNode_, this.readArrayElementNode__exportNode_, readArrayElementNode__thisLibrary__);
                    }
