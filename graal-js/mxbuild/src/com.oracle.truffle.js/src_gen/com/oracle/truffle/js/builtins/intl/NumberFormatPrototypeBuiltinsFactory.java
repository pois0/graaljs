...
import com.oracle.truffle.js.builtins.intl.NumberFormatPrototypeBuiltins.JSNumberFormatFormatToPartsNode;
import com.oracle.truffle.js.builtins.intl.NumberFormatPrototypeBuiltins.JSNumberFormatResolvedOptionsNode;
...
public final class NumberFormatPrototypeBuiltinsFactory {
    ...
    @GeneratedBy(JSNumberFormatResolvedOptionsNode.class)
    public static final class JSNumberFormatResolvedOptionsNodeGen extends JSNumberFormatResolvedOptionsNode implements Provider {
        ...
        public Object execute(VirtualFrame frameValue) {
            ...
            if ((state & 0b1) != 0 /* is-active doResolvedOptions(DynamicObject) */ && JSTypes.isDynamicObject(arguments0Value_)) {
                ...
                if ((JSGuards.isJSNumberFormat(arguments0Value__))) {
        ...
        private Object executeAndSpecialize(Object arguments0Value) {
            ...
            if (JSTypes.isDynamicObject(arguments0Value)) {
                ...
                if ((JSGuards.isJSNumberFormat(arguments0Value_))) {
        ...
        public static JSNumberFormatResolvedOptionsNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
            return new JSNumberFormatResolvedOptionsNodeGen(context, builtin, arguments);
        }

    }
    @GeneratedBy(JSNumberFormatFormatToPartsNode.class)
    public static final class JSNumberFormatFormatToPartsNodeGen extends JSNumberFormatFormatToPartsNode implements Provider {
        ...
        public Object execute(VirtualFrame frameValue) {
            ...
            if ((state & 0b1) != 0 /* is-active doFormatToParts(DynamicObject, Object) */ && JSTypes.isDynamicObject(arguments0Value_)) {
                DynamicObject arguments0Value__ = (DynamicObject) arguments0Value_;
                if ((JSGuards.isJSNumberFormat(arguments0Value__))) {
        ...
        public void executeVoid(VirtualFrame frameValue) {
            int state = state_;
            if ((state & 0b1) != 0 /* is-active doFormatToParts(DynamicObject, Object) */) {
                execute(frameValue);
                return;
            }
            Object arguments0Value_ = this.arguments0_.execute(frameValue);
        ...
        private Object executeAndSpecialize(Object arguments0Value, Object arguments1Value) {
            ...
            if (JSTypes.isDynamicObject(arguments0Value)) {
                DynamicObject arguments0Value_ = (DynamicObject) arguments0Value;
                if ((JSGuards.isJSNumberFormat(arguments0Value_))) {
                    this.state_ = state = state | 0b1 /* add-active doFormatToParts(DynamicObject, Object) */;
        ...
        public static JSNumberFormatFormatToPartsNode create(JSContext context, JSBuiltin builtin, JavaScriptNode[] arguments) {
