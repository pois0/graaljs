...
public final class JSBitwiseOrConstantNodeGen extends JSBitwiseOrConstantNode implements Provider {

    @CompilationFinal private volatile int state_;
    @CompilationFinal private volatile int exclude_;
    @Child private JSToInt32Node double_leftInt32_;
    @Child private GenericIntCaseData genericIntCase_cache;
    ...
    public Object executeObject(Object operandNodeValue) {
        ...
        if ((state & 0b110000000) != 0 /* is-active doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) || doGenericBigIntCase(Object, JSToNumericNode, ConditionProfile) */) {
            if ((state & 0b10000000) != 0 /* is-active doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) */) {
                GenericIntCaseData s8_ = this.genericIntCase_cache;
                if (s8_ != null) {
                    assert (isInt);
                    return doGenericIntCase(operandNodeValue, s8_.toNumeric_, s8_.profileIsBigInt_, s8_.innerOrNode_);
                }
            }
    ...
    public Object execute(VirtualFrame frameValue) {
        int state = state_;
        if ((state & 0b111000110) == 0 /* only-active doInteger(int) */ && (state & 0b111000111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) && doGenericBigIntCase(Object, JSToNumericNode, ConditionProfile) */) {
            return execute_int0(frameValue, state);
        } else if ((state & 0b111000011) == 0 /* only-active doDouble(double, JSToInt32Node) */ && (state & 0b111000111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) && doGenericBigIntCase(Object, JSToNumericNode, ConditionProfile) */) {
    ...
    private Object execute_double1(VirtualFrame frameValue, int state) {
        ...
        try {
            if ((state & 0b1110000000000) == 0 /* only-active 0:double */ && (state & 0b111111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doIntegerThrows(int) && doDoubleThrows(double) && doBigIntThrows(BigInt) && doBigInt(BigInt) && doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) && doGenericBigIntCase(Object, JSToNumericNode, ConditionProfile) */) {
    ...
    private Object execute_generic2(VirtualFrame frameValue, int state) {
        ...
        if ((state & 0b110000000) != 0 /* is-active doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) || doGenericBigIntCase(Object, JSToNumericNode, ConditionProfile) */) {
            if ((state & 0b10000000) != 0 /* is-active doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) */) {
                ...
                if (s8_ != null) {
                    assert (isInt);
                    return doGenericIntCase(operandNodeValue_, s8_.toNumeric_, s8_.profileIsBigInt_, s8_.innerOrNode_);
                }
            }
            if ((state & 0b100000000) != 0 /* is-active doGenericBigIntCase(Object, JSToNumericNode, ConditionProfile) */) {
                assert (!(isInt()));
    ...
    public void executeVoid(VirtualFrame frameValue) {
        ...
        try {
            if ((state & 0b111111000) == 0 /* only-active doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) */ && (state & 0b111111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doIntegerThrows(int) && doDoubleThrows(double) && doBigIntThrows(BigInt) && doBigInt(BigInt) && doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) && doGenericBigIntCase(Object, JSToNumericNode, ConditionProfile) */) {
                ...
                return;
            } else if ((state & 0b111000111) != 0 /* is-active doInteger(int) || doSafeInteger(SafeInteger) || doDouble(double, JSToInt32Node) || doBigInt(BigInt) || doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) || doGenericBigIntCase(Object, JSToNumericNode, ConditionProfile) */) {
                execute(frameValue);
                return;
            }
        } catch (UnexpectedResultException ex) {
    ...
    private Object executeAndSpecialize(Object operandNodeValue) {
        ...
        try {
            ...
            if ((isInt)) {
                ...
                s8_.innerOrNode_ = s8_.insertAccessor((makeCopy()));
                ...
                this.state_ = state = state | 0b10000000 /* add-active doGenericIntCase(Object, JSToNumericNode, ConditionProfile, JavaScriptNode) */;
                lock.unlock();
                hasLock = false;
                return doGenericIntCase(operandNodeValue, s8_.toNumeric_, s8_.profileIsBigInt_, s8_.innerOrNode_);
            }
    ...
    private static final class GenericIntCaseData extends Node {
        ...
        @Child JavaScriptNode innerOrNode_;
