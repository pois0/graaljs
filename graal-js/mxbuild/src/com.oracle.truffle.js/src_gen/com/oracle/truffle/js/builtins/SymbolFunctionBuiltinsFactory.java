...
public final class SymbolFunctionBuiltinsFactory {
    ...
    public static final class SymbolForNodeGen extends SymbolForNode implements Provider {
    ...
    public static final class SymbolKeyForNodeGen extends SymbolKeyForNode implements Provider {
        ...
        public Object execute(VirtualFrame frameValue) {
            int state = state_;
            Object arguments0Value_ = this.arguments0_.execute(frameValue);
            if ((state & 0b1) != 0 /* is-active symbolKeyFor(Symbol) */ && arguments0Value_ instanceof Symbol) {
            ...
            if ((state & 0b10) != 0 /* is-active valueOf(Object) */) {
        ...
        private Object executeAndSpecialize(Object arguments0Value) {
            ...
            if (arguments0Value instanceof Symbol) {
                ...
                if ((JSGuards.isSymbol(arguments0Value_))) {
                    this.state_ = state = state | 0b1 /* add-active symbolKeyFor(Symbol) */;
                    return symbolKeyFor(arguments0Value_);
                }
            }
            if ((!(JSGuards.isSymbol(arguments0Value)))) {
                this.state_ = state = state | 0b10 /* add-active valueOf(Object) */;
        ...
        public Introspection getIntrospectionData() {
            ...
            s = new Object[3];
            s[0] = "symbolKeyFor";
            if ((state & 0b1) != 0 /* is-active symbolKeyFor(Symbol) */) {
                s[1] = (byte)0b01 /* active */;
            } else {
