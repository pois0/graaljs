...
public final class StringIteratorPrototypeBuiltinsFactory {
    ...
    public static final class StringIteratorNextNodeGen extends StringIteratorNextNode implements Provider {
        ...
        public Object execute(VirtualFrame frameValue) {
            ...
            if ((state & 0b1) != 0 /* is-active doStringIterator(VirtualFrame, DynamicObject) */ && JSTypes.isDynamicObject(arguments0Value_)) {
        ...
        private DynamicObject executeAndSpecialize(VirtualFrame frameValue, Object arguments0Value) {
            ...
            if (JSTypes.isDynamicObject(arguments0Value)) {
                DynamicObject arguments0Value_ = (DynamicObject) arguments0Value;
                if ((isStringIterator(arguments0Value_))) {
                    this.state_ = state = state | 0b1 /* add-active doStringIterator(VirtualFrame, DynamicObject) */;
        ...
        public Introspection getIntrospectionData() {
            ...
            if ((state & 0b1) != 0 /* is-active doStringIterator(VirtualFrame, DynamicObject) */) {
