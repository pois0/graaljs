...
public final class JSToStringOrNumberNodeGen extends JSToStringOrNumberNode implements Provider {
    ...
    public Object execute(Object arg0Value) {
        ...
        if ((state & 0b1000) != 0 /* is-active doLong(long) */ && arg0Value instanceof Long) {
            long arg0Value_ = (long) arg0Value;
            return doLong(arg0Value_);
        }
        if ((state & 0b10000) != 0 /* is-active doDouble(double) */ && JSTypesGen.isImplicitDouble((state & 0b111100000000000) >>> 11 /* extract-implicit-active 0:double */, arg0Value)) {
        ...
        if ((state & 0b1000000) != 0 /* is-active doJSObject(DynamicObject, JSToDoubleNode) */ && JSTypes.isDynamicObject(arg0Value)) {
            DynamicObject arg0Value_ = (DynamicObject) arg0Value;
            if ((JSGuards.isJSObject(arg0Value_))) {
                return doJSObject(arg0Value_, this.jSObject_toDoubleNode_);
            }
        }
        ...
        try {
            ...
            if (JSTypes.isDynamicObject(arg0Value)) {
                ...
                if ((JSGuards.isJSObject(arg0Value_))) {
                    ...
                    this.state_ = state = state | 0b1000000 /* add-active doJSObject(DynamicObject, JSToDoubleNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doJSObject(arg0Value_, this.jSObject_toDoubleNode_);
                }
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "doJSObject";
        if ((state & 0b1000000) != 0 /* is-active doJSObject(DynamicObject, JSToDoubleNode) */) {
            s[1] = (byte)0b01 /* active */;
