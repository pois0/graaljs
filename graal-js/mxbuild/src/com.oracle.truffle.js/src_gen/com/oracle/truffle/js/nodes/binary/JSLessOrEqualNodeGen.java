...
public final class JSLessOrEqualNodeGen extends JSLessOrEqualNode implements Provider {
    ...
    public boolean executeBoolean(Object leftNodeValue, Object rightNodeValue) {
        ...
        if ((state & 0x18000L) != 0 /* is-active doJavaNumber(Object, Object) || doGeneric(Object, Object, JSToStringOrNumberNode, JSToPrimitiveNode, JSToStringOrNumberNode, JSToPrimitiveNode, JSLessOrEqualNode) */) {
            ...
            if ((state & 0x10000L) != 0 /* is-active doGeneric(Object, Object, JSToStringOrNumberNode, JSToPrimitiveNode, JSToStringOrNumberNode, JSToPrimitiveNode, JSLessOrEqualNode) */) {
                GenericData s17_ = this.generic_cache;
                if (s17_ != null) {
                    return doGeneric(leftNodeValue, rightNodeValue, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.lessOrEqualNode_);
                }
            }
        }
    ...
    public boolean executeBoolean(VirtualFrame frameValue) {
        long state = state_;
        if ((state & 0x1fffeL) == 0 /* only-active doInt(int, int) */ && (state & 0x1ffffL) != 0  /* is-not doInt(int, int) && doSafeInteger(int, SafeInteger) && doSafeInteger(SafeInteger, int) && doSafeInteger(SafeInteger, SafeInteger) && doDouble(double, double) && doString(String, String) && doStringDouble(String, double) && doDoubleString(double, String) && doStringBigInt(String, BigInt) && doBigIntString(BigInt, String) && doBigInt(BigInt, BigInt) && doBigIntAndInt(BigInt, int) && doBigIntAndNumber(BigInt, double) && doIntAndBigInt(int, BigInt) && doNumberAndBigInt(double, BigInt) && doJavaNumber(Object, Object) && doGeneric(Object, Object, JSToStringOrNumberNode, JSToPrimitiveNode, JSToStringOrNumberNode, JSToPrimitiveNode, JSLessOrEqualNode) */) {
    ...
    private boolean executeBoolean_generic6(VirtualFrame frameValue, long state) {
        ...
        if ((state & 0x18000L) != 0 /* is-active doJavaNumber(Object, Object) || doGeneric(Object, Object, JSToStringOrNumberNode, JSToPrimitiveNode, JSToStringOrNumberNode, JSToPrimitiveNode, JSLessOrEqualNode) */) {
            ...
            if ((state & 0x10000L) != 0 /* is-active doGeneric(Object, Object, JSToStringOrNumberNode, JSToPrimitiveNode, JSToStringOrNumberNode, JSToPrimitiveNode, JSLessOrEqualNode) */) {
                GenericData s17_ = this.generic_cache;
                if (s17_ != null) {
                    return doGeneric(leftNodeValue_, rightNodeValue_, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.lessOrEqualNode_);
                }
            }
        }
        CompilerDirectives.transferToInterpreterAndInvalidate();
    ...
    private boolean executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            this.state_ = state = state | 0x10000L /* add-active doGeneric(Object, Object, JSToStringOrNumberNode, JSToPrimitiveNode, JSToStringOrNumberNode, JSToPrimitiveNode, JSLessOrEqualNode) */;
            lock.unlock();
            hasLock = false;
            return doGeneric(leftNodeValue, rightNodeValue, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.lessOrEqualNode_);
        } finally {
    ...
    private static final class GenericData extends Node {
        ...
        @Child JSLessOrEqualNode lessOrEqualNode_;
