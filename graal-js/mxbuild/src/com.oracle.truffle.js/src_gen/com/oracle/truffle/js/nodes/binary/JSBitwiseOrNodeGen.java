...
public final class JSBitwiseOrNodeGen extends JSBitwiseOrNode implements Provider {
    ...
    public Object executeObject(Object leftNodeValue, Object rightNodeValue) {
        ...
        if ((state & 0b1000000) != 0 /* is-active doGeneric(Object, Object, JSToNumericNode, JSToNumericNode, JSBitwiseOrNode, BranchProfile) */) {
            GenericData s7_ = this.generic_cache;
            if (s7_ != null) {
                return doGeneric(leftNodeValue, rightNodeValue, s7_.leftNumeric_, s7_.rightNumeric_, s7_.or_, s7_.mixedNumericTypes_);
            }
        }
    ...
    private Object execute_double_double1(VirtualFrame frameValue, int state) {
        ...
        try {
            ...
            return executeAndSpecialize(((state & 0b11100000000) == 0 /* only-active 0:double */ && (state & 0b1111111) != 0  /* is-not doInteger(int, int) && doSafeIntegerInt(SafeInteger, int) && doIntSafeInteger(int, SafeInteger) && doSafeInteger(SafeInteger, SafeInteger) && doDouble(double, double, JSToInt32Node, JSToInt32Node) && doBigInt(BigInt, BigInt) && doGeneric(Object, Object, JSToNumericNode, JSToNumericNode, JSBitwiseOrNode, BranchProfile) */ ? (Object) leftNodeValue_long : ((state & 0b11010000000) == 0 /* only-active 0:double */ && (state & 0b1111111) != 0  /* is-not doInteger(int, int) && doSafeIntegerInt(SafeInteger, int) && doIntSafeInteger(int, SafeInteger) && doSafeInteger(SafeInteger, SafeInteger) && doDouble(double, double, JSToInt32Node, JSToInt32Node) && doBigInt(BigInt, BigInt) && doGeneric(Object, Object, JSToNumericNode, JSToNumericNode, JSBitwiseOrNode, BranchProfile) */ ? (Object) leftNodeValue_int : (Object) leftNodeValue_)), ex.getResult());
        }
    ...
    private Object execute_generic4(VirtualFrame frameValue, int state) {
        ...
        if ((state & 0b1000000) != 0 /* is-active doGeneric(Object, Object, JSToNumericNode, JSToNumericNode, JSBitwiseOrNode, BranchProfile) */) {
            GenericData s7_ = this.generic_cache;
            if (s7_ != null) {
                return doGeneric(leftNodeValue_, rightNodeValue_, s7_.leftNumeric_, s7_.rightNumeric_, s7_.or_, s7_.mixedNumericTypes_);
            }
        }
        CompilerDirectives.transferToInterpreterAndInvalidate();
        return executeAndSpecialize(leftNodeValue_, rightNodeValue_);
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            this.state_ = state = state | 0b1000000 /* add-active doGeneric(Object, Object, JSToNumericNode, JSToNumericNode, JSBitwiseOrNode, BranchProfile) */;
            lock.unlock();
            hasLock = false;
            return doGeneric(leftNodeValue, rightNodeValue, s7_.leftNumeric_, s7_.rightNumeric_, s7_.or_, s7_.mixedNumericTypes_);
        } finally {
