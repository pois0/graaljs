...
final class JSFunctionObjectGen {
    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private static final class Cached extends InteropLibrary {
            ...
            private final Class<? extends JSFunctionObject> receiverClass_;
            ...
            Cached(Object originalReceiver) {
                JSFunctionObject receiver = ((JSFunctionObject) originalReceiver) ;
            ...
            public Object getMembers(Object arg0Value_, boolean arg1Value) throws UnsupportedMessageException {
                ...
                JSFunctionObject arg0Value = CompilerDirectives.castExact(arg0Value_, receiverClass_);
                int state = state_;
            ...
            public boolean isExecutable(Object arg0Value_) {
                ...
                JSFunctionObject arg0Value = CompilerDirectives.castExact(arg0Value_, receiverClass_);
                int state = state_;
                if ((state & 0b1000000000000) != 0 /* is-active isExecutable(JSFunctionObject, IsCallableNode) */) {
            ...
            private boolean isExecutableNode_AndSpecialize(JSFunctionObject arg0Value) {
                ...
                try {
                    ...
                    this.state_ = state = state | 0b1000000000000 /* add-active isExecutable(JSFunctionObject, IsCallableNode) */;
                    lock.unlock();
                    hasLock = false;
                    return arg0Value.isExecutable(this.isExecutableNode__isCallable_);
                } finally {
            ...
            public Object execute(Object arg0Value_, Object... arg1Value) throws UnsupportedTypeException, ArityException, UnsupportedMessageException {
                ...
                JSFunctionObject arg0Value = CompilerDirectives.castExact(arg0Value_, receiverClass_);
                int state = state_;
                if ((state & 0b10000000000000) != 0 /* is-active execute(JSFunctionObject, Object[], JavaScriptLanguage, JSInteropExecuteNode, ExportValueNode) */) {
                    {
                        LanguageReference<JavaScriptLanguage> javaScriptLanguageReference__ = this.javaScriptLanguageReference_;
                ...
                try {
                    {
                        ...
                        this.state_ = state = state | 0b10000000000000 /* add-active execute(JSFunctionObject, Object[], JavaScriptLanguage, JSInteropExecuteNode, ExportValueNode) */;
                        lock.unlock();
                        hasLock = false;
                        return arg0Value.execute(arg1Value, executeNode__language__, this.executeNode__callNode_, this.exportValue);
                    }
            ...
            public Object instantiate(Object arg0Value_, Object... arg1Value) throws UnsupportedTypeException, ArityException, UnsupportedMessageException {
                ...
                JSFunctionObject arg0Value = CompilerDirectives.castExact(arg0Value_, receiverClass_);
                int state = state_;
                if ((state & 0b100000000000000) != 0 /* is-active instantiate(JSFunctionObject, Object[], JavaScriptLanguage, JSInteropInstantiateNode, ExportValueNode) */) {
                    {
                        LanguageReference<JavaScriptLanguage> javaScriptLanguageReference__ = this.javaScriptLanguageReference_;
                ...
                try {
                    {
                        ...
                        this.state_ = state = state | 0b100000000000000 /* add-active instantiate(JSFunctionObject, Object[], JavaScriptLanguage, JSInteropInstantiateNode, ExportValueNode) */;
                        lock.unlock();
                        hasLock = false;
                        return arg0Value.instantiate(arg1Value, instantiateNode__language__, this.instantiateNode__callNode_, this.exportValue);
                    }
            ...
            public SourceSection getSourceLocation(Object receiver) throws UnsupportedMessageException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (CompilerDirectives.castExact(receiver, receiverClass_)).getSourceLocation();
            }
            ...
            public boolean isMetaObject(Object receiver) {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (CompilerDirectives.castExact(receiver, receiverClass_)).isMetaObject();
            }
            ...
            public Object getMetaQualifiedName(Object receiver) throws UnsupportedMessageException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (CompilerDirectives.castExact(receiver, receiverClass_)).getMetaObjectName();
            }
            ...
            public boolean isMetaInstance(Object receiver, Object instance) throws UnsupportedMessageException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (CompilerDirectives.castExact(receiver, receiverClass_)).isMetaInstance(instance);
            }
        ...
        private static final class Uncached extends InteropLibrary {
            ...
            Uncached(Object receiver) {
                this.receiverClass_ = ((JSFunctionObject) receiver).getClass();
            }
            ...
            public Object execute(Object arg0Value_, Object... arg1Value) throws UnsupportedMessageException {
                assert this.accepts(arg0Value_) : "Invalid library usage. Library does not accept given receiver.";
                JSFunctionObject arg0Value = ((JSFunctionObject) arg0Value_);
                return arg0Value.execute(arg1Value, this.javaScriptLanguageReference_.get(), (JSInteropExecuteNodeGen.getUncached()), (ExportValueNodeGen.getUncached()));
            }
            ...
            public Object instantiate(Object arg0Value_, Object... arg1Value) throws UnsupportedMessageException {
                assert this.accepts(arg0Value_) : "Invalid library usage. Library does not accept given receiver.";
                JSFunctionObject arg0Value = ((JSFunctionObject) arg0Value_);
                return arg0Value.instantiate(arg1Value, this.javaScriptLanguageReference_.get(), (JSInteropInstantiateNodeGen.getUncached()), (ExportValueNodeGen.getUncached()));
            }
