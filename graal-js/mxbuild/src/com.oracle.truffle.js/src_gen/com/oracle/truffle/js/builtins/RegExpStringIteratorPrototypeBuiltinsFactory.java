...
public final class RegExpStringIteratorPrototypeBuiltinsFactory {
    ...
    public static final class RegExpStringIteratorNextNodeGen extends RegExpStringIteratorNextNode implements Provider {
        ...
        public Object execute(VirtualFrame frameValue) {
            ...
            if ((state & 0b1) != 0 /* is-active doRegExpStringIterator(VirtualFrame, DynamicObject) */ && JSTypes.isDynamicObject(arguments0Value_)) {
        ...
        private DynamicObject executeAndSpecialize(VirtualFrame frameValue, Object arguments0Value) {
            ...
            if (JSTypes.isDynamicObject(arguments0Value)) {
                DynamicObject arguments0Value_ = (DynamicObject) arguments0Value;
                if ((isRegExpStringIterator(arguments0Value_))) {
                    this.state_ = state = state | 0b1 /* add-active doRegExpStringIterator(VirtualFrame, DynamicObject) */;
        ...
        public Introspection getIntrospectionData() {
            ...
            if ((state & 0b1) != 0 /* is-active doRegExpStringIterator(VirtualFrame, DynamicObject) */) {
