...
final class JSProxyObjectGen {
    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private InteropLibraryExports() {
            super(InteropLibrary.class, JSProxyObject.class, false);
        }
        ...
        private static final class Cached extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert !(receiver instanceof JSProxyObject) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
                return receiver instanceof JSProxyObject;
            }
            ...
            public boolean hasMembers(Object receiver) {
                ...
                assert assertAdopted();
                return (((JSProxyObject) receiver)).hasMembers();
            }
            ...
            public void removeMember(Object receiver, String member) throws UnsupportedMessageException, UnknownIdentifierException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                (((JSProxyObject) receiver)).removeMember(member);
                return;
            }
            ...
            public boolean hasLanguage(Object receiver) {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSProxyObject) receiver)).hasLanguage();
            }
            ...
            public Class<? extends TruffleLanguage<?>> getLanguage(Object receiver) throws UnsupportedMessageException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSProxyObject) receiver)).getLanguage();
            }
            ...
            public Object toDisplayString(Object receiver, boolean allowSideEffects) {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSProxyObject) receiver)).toDisplayString(allowSideEffects);
            }
            ...
            public boolean isExecutable(Object arg0Value_) {
                ...
                JSProxyObject arg0Value = ((JSProxyObject) arg0Value_);
                int state = state_;
                if ((state & 0b1000000000000) != 0 /* is-active isExecutable(JSProxyObject, IsCallableNode) */) {
            ...
            private boolean isExecutableNode_AndSpecialize(JSProxyObject arg0Value) {
                ...
                try {
                    ...
                    this.state_ = state = state | 0b1000000000000 /* add-active isExecutable(JSProxyObject, IsCallableNode) */;
                    lock.unlock();
                    hasLock = false;
                    return arg0Value.isExecutable(this.isExecutableNode__isCallable_);
                } finally {
            ...
            public Object execute(Object arg0Value_, Object... arg1Value) throws UnsupportedTypeException, ArityException, UnsupportedMessageException {
                ...
                JSProxyObject arg0Value = ((JSProxyObject) arg0Value_);
                int state = state_;
                if ((state & 0b10000000000000) != 0 /* is-active execute(JSProxyObject, Object[], JavaScriptLanguage, JSRealm, JSInteropExecuteNode, ExportValueNode) */) {
                    {
                        LanguageReference<JavaScriptLanguage> javaScriptLanguageReference__ = this.javaScriptLanguageReference_;
                        ...
                        return arg0Value.execute(arg1Value, executeNode__language__, executeNode__realm__, this.executeNode__callNode_, this.exportValue);
                    }
                }
                CompilerDirectives.transferToInterpreterAndInvalidate();
                ...
                try {
                    {
                        ...
                        this.state_ = state = state | 0b10000000000000 /* add-active execute(JSProxyObject, Object[], JavaScriptLanguage, JSRealm, JSInteropExecuteNode, ExportValueNode) */;
                        lock.unlock();
                        hasLock = false;
                        return arg0Value.execute(arg1Value, executeNode__language__, executeNode__realm__, this.executeNode__callNode_, this.exportValue);
                    }
            ...
            public Object instantiate(Object arg0Value_, Object... arg1Value) throws UnsupportedTypeException, ArityException, UnsupportedMessageException {
                ...
                JSProxyObject arg0Value = ((JSProxyObject) arg0Value_);
                int state = state_;
                if ((state & 0b100000000000000) != 0 /* is-active instantiate(JSProxyObject, Object[], JavaScriptLanguage, JSRealm, JSInteropInstantiateNode, ExportValueNode) */) {
                    {
                        LanguageReference<JavaScriptLanguage> javaScriptLanguageReference__ = this.javaScriptLanguageReference_;
                        ...
                        return arg0Value.instantiate(arg1Value, instantiateNode__language__, instantiateNode__realm__, this.instantiateNode__callNode_, this.exportValue);
                    }
                }
                CompilerDirectives.transferToInterpreterAndInvalidate();
                ...
                try {
                    {
                        ...
                        this.state_ = state = state | 0b100000000000000 /* add-active instantiate(JSProxyObject, Object[], JavaScriptLanguage, JSRealm, JSInteropInstantiateNode, ExportValueNode) */;
                        lock.unlock();
                        hasLock = false;
                        return arg0Value.instantiate(arg1Value, instantiateNode__language__, instantiateNode__realm__, this.instantiateNode__callNode_, this.exportValue);
                    }
        ...
        private static final class Uncached extends InteropLibrary {
            ...
            public Object instantiate(Object arg0Value_, Object... arg1Value) throws UnsupportedMessageException {
                assert this.accepts(arg0Value_) : "Invalid library usage. Library does not accept given receiver.";
                JSProxyObject arg0Value = ((JSProxyObject) arg0Value_);
                return arg0Value.instantiate(arg1Value, this.javaScriptLanguageReference_.get(), this.javaScriptLanguageContextReference_.get(), (JSInteropInstantiateNodeGen.getUncached()), (ExportValueNodeGen.getUncached()));
            }
