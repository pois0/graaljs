    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private static final class Cached extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert !(receiver instanceof JSDateObject) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export. Exported receiver with dynamic dispatch found but not expected.";
                return receiver instanceof JSDateObject;
            }
            ...
            public boolean hasMembers(Object receiver) {
                ...
                assert assertAdopted();
                return (((JSDateObject) receiver)).hasMembers();
            }
            ...
            public void removeMember(Object receiver, String member) throws UnsupportedMessageException, UnknownIdentifierException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                (((JSDateObject) receiver)).removeMember(member);
                return;
            }
            ...
            public boolean hasLanguage(Object receiver) {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSDateObject) receiver)).hasLanguage();
            }
            ...
            public Class<? extends TruffleLanguage<?>> getLanguage(Object receiver) throws UnsupportedMessageException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSDateObject) receiver)).getLanguage();
            }
            ...
            public Object toDisplayString(Object receiver, boolean allowSideEffects) {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSDateObject) receiver)).toDisplayString(allowSideEffects);
            }
            ...
            public boolean hasMetaObject(Object receiver) {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSDateObject) receiver)).hasMetaObject();
            }
            ...
            public Object getMetaObject(Object receiver) throws UnsupportedMessageException {
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                assert assertAdopted();
                return (((JSDateObject) receiver)).getMetaObject();
            }
            ...
            public LocalDate asDate(Object arg0Value_) throws UnsupportedMessageException {
                ...
                JSDateObject arg0Value = ((JSDateObject) arg0Value_);
                int state = state_;
                if ((state & 0b1000000000000) != 0 /* is-active asDate(JSDateObject, ContextReference<JSRealm>) */) {
                    {
                        ContextReference<JSRealm> javaScriptLanguageContextReference__ = this.javaScriptLanguageContextReference_;
                        ContextReference<JSRealm> asDateNode__contextRef__ = javaScriptLanguageContextReference__;
            ...
            private LocalDate asDateNode_AndSpecialize(JSDateObject arg0Value) throws UnsupportedMessageException {
                ...
                try {
                    {
                        ContextReference<JSRealm> asDateNode__contextRef__ = null;
                        ContextReference<JSRealm> javaScriptLanguageContextReference__1 = this.javaScriptLanguageContextReference_;
                        if (javaScriptLanguageContextReference__1 == null) {
                            this.javaScriptLanguageContextReference_ = javaScriptLanguageContextReference__1 = super.lookupContextReference(JavaScriptLanguage.class);
                        }
                        asDateNode__contextRef__ = javaScriptLanguageContextReference__1;
                        this.state_ = state = state | 0b1000000000000 /* add-active asDate(JSDateObject, ContextReference<JSRealm>) */;
                        lock.unlock();
                        hasLock = false;
                        return arg0Value.asDate(asDateNode__contextRef__);
                    }
            ...
            public LocalTime asTime(Object arg0Value_) throws UnsupportedMessageException {
                ...
                JSDateObject arg0Value = ((JSDateObject) arg0Value_);
                int state = state_;
                if ((state & 0b10000000000000) != 0 /* is-active asTime(JSDateObject, ContextReference<JSRealm>) */) {
                    {
                        ContextReference<JSRealm> javaScriptLanguageContextReference__ = this.javaScriptLanguageContextReference_;
                        ContextReference<JSRealm> asTimeNode__contextRef__ = javaScriptLanguageContextReference__;
            ...
            private LocalTime asTimeNode_AndSpecialize(JSDateObject arg0Value) throws UnsupportedMessageException {
                ...
                try {
                    {
                        ContextReference<JSRealm> asTimeNode__contextRef__ = null;
                        ContextReference<JSRealm> javaScriptLanguageContextReference__1 = this.javaScriptLanguageContextReference_;
                        if (javaScriptLanguageContextReference__1 == null) {
                            this.javaScriptLanguageContextReference_ = javaScriptLanguageContextReference__1 = super.lookupContextReference(JavaScriptLanguage.class);
                        }
                        asTimeNode__contextRef__ = javaScriptLanguageContextReference__1;
                        this.state_ = state = state | 0b10000000000000 /* add-active asTime(JSDateObject, ContextReference<JSRealm>) */;
                        lock.unlock();
                        hasLock = false;
                        return arg0Value.asTime(asTimeNode__contextRef__);
                    }
            ...
            public ZoneId asTimeZone(Object arg0Value_) throws UnsupportedMessageException {
                ...
                JSDateObject arg0Value = ((JSDateObject) arg0Value_);
                int state = state_;
                if ((state & 0b100000000000000) != 0 /* is-active asTimeZone(JSDateObject, ContextReference<JSRealm>) */) {
                    {
                        ContextReference<JSRealm> javaScriptLanguageContextReference__ = this.javaScriptLanguageContextReference_;
                        ContextReference<JSRealm> asTimeZoneNode__contextRef__ = javaScriptLanguageContextReference__;
            ...
            private ZoneId asTimeZoneNode_AndSpecialize(JSDateObject arg0Value) throws UnsupportedMessageException {
                ...
                try {
                    {
                        ContextReference<JSRealm> asTimeZoneNode__contextRef__ = null;
                        ContextReference<JSRealm> javaScriptLanguageContextReference__1 = this.javaScriptLanguageContextReference_;
                        if (javaScriptLanguageContextReference__1 == null) {
                            this.javaScriptLanguageContextReference_ = javaScriptLanguageContextReference__1 = super.lookupContextReference(JavaScriptLanguage.class);
                        }
                        asTimeZoneNode__contextRef__ = javaScriptLanguageContextReference__1;
                        this.state_ = state = state | 0b100000000000000 /* add-active asTimeZone(JSDateObject, ContextReference<JSRealm>) */;
                        lock.unlock();
                        hasLock = false;
                        return arg0Value.asTimeZone(asTimeZoneNode__contextRef__);
                    }
