...
public final class JSArrayLastElementIndexNodeGen extends JSArrayLastElementIndexNode implements Provider {
    ...
    public long executeLong(Object arg0Value, long arg1Value, boolean arg2Value) {
        int state = state_;
        if (state != 0 /* is-active doWithoutHolesCached(DynamicObject, long, boolean, ScriptArray) || doWithoutHolesUncached(DynamicObject, long, boolean) || doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) || doWithHolesUncached(DynamicObject, long, boolean, JSArrayPreviousElementIndexNode, ConditionProfile, ValueProfile) || doObjectViaEnumeration(DynamicObject, long, boolean, JSHasPropertyNode) || doObjectViaFullEnumeration(DynamicObject, long, boolean, JSHasPropertyNode) || doObject(Object, long, boolean, JSHasPropertyNode) */) {
            if ((state & 0b111111) != 0 /* is-active doWithoutHolesCached(DynamicObject, long, boolean, ScriptArray) || doWithoutHolesUncached(DynamicObject, long, boolean) || doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) || doWithHolesUncached(DynamicObject, long, boolean, JSArrayPreviousElementIndexNode, ConditionProfile, ValueProfile) || doObjectViaEnumeration(DynamicObject, long, boolean, JSHasPropertyNode) || doObjectViaFullEnumeration(DynamicObject, long, boolean, JSHasPropertyNode) */ && JSTypes.isDynamicObject(arg0Value)) {
                ...
                if ((state & 0b100) != 0 /* is-active doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) */ && (arg2Value) && (!(hasPrototypeElements(arg0Value_)))) {
                    ...
                    while (s3_ != null) {
                        if ((JSArrayElementIndexNode.getArrayType(arg0Value_) == s3_.cachedArrayType_) && (s3_.cachedArrayType_.hasHoles(arg0Value_))) {
                            return doWithHolesCached(arg0Value_, arg1Value, arg2Value, s3_.cachedArrayType_, s3_.previousElementIndexNode_, s3_.isLengthMinusOne_);
                        }
                        s3_ = s3_.next_;
                    }
                }
                if ((state & 0b1000) != 0 /* is-active doWithHolesUncached(DynamicObject, long, boolean, JSArrayPreviousElementIndexNode, ConditionProfile, ValueProfile) */) {
                    WithHolesUncachedData s4_ = this.withHolesUncached_cache;
                    if (s4_ != null) {
                        if ((arg2Value) && (hasPrototypeElements(arg0Value_) || JSArrayElementIndexNode.hasHoles(arg0Value_))) {
                            return doWithHolesUncached(arg0Value_, arg1Value, arg2Value, s4_.previousElementIndexNode_, s4_.isLengthMinusOne_, s4_.arrayTypeProfile_);
                        }
                    }
                }
                if ((state & 0b10000) != 0 /* is-active doObjectViaEnumeration(DynamicObject, long, boolean, JSHasPropertyNode) */) {
                ...
                if ((state & 0b100000) != 0 /* is-active doObjectViaFullEnumeration(DynamicObject, long, boolean, JSHasPropertyNode) */) {
    ...
    private long executeAndSpecialize(Object arg0Value, long arg1Value, boolean arg2Value) {
        ...
        try {
            if (JSTypes.isDynamicObject(arg0Value)) {
                ...
                if (((exclude & 0b10)) == 0 /* is-not-excluded doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) */ && (arg2Value) && (!(hasPrototypeElements(arg0Value_)))) {
                    int count3_ = 0;
                    WithHolesCachedData s3_ = this.withHolesCached_cache;
                    if ((state & 0b100) != 0 /* is-active doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) */) {
                        while (s3_ != null) {
                            if ((JSArrayElementIndexNode.getArrayType(arg0Value_) == s3_.cachedArrayType_) && (s3_.cachedArrayType_.hasHoles(arg0Value_))) {
                                break;
                            }
                    ...
                    if (s3_ == null) {
                        {
                            ...
                            if ((JSArrayElementIndexNode.getArrayType(arg0Value_) == cachedArrayType__1) && (cachedArrayType__1.hasHoles(arg0Value_)) && count3_ < (JSArrayElementIndexNode.MAX_CACHED_ARRAY_TYPES)) {
                                ...
                                this.state_ = state = state | 0b100 /* add-active doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) */;
                            }
                        }
                    }
                    if (s3_ != null) {
                ...
                if ((arg2Value) && (hasPrototypeElements(arg0Value_) || JSArrayElementIndexNode.hasHoles(arg0Value_))) {
                    ...
                    s4_.isLengthMinusOne_ = (ConditionProfile.createBinaryProfile());
                    s4_.arrayTypeProfile_ = (ValueProfile.createClassProfile());
                    this.withHolesUncached_cache = s4_;
                    this.exclude_ = exclude = exclude | 0b10 /* add-excluded doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) */;
                    this.withHolesCached_cache = null;
                    state = state & 0xfffffffb /* remove-active doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) */;
                    this.state_ = state = state | 0b1000 /* add-active doWithHolesUncached(DynamicObject, long, boolean, JSArrayPreviousElementIndexNode, ConditionProfile, ValueProfile) */;
                    lock.unlock();
                    hasLock = false;
                    return doWithHolesUncached(arg0Value_, arg1Value, arg2Value, s4_.previousElementIndexNode_, s4_.isLengthMinusOne_, s4_.arrayTypeProfile_);
                }
                if ((!(arg2Value)) && (isSuitableForEnumBasedProcessingUsingOwnKeys(arg0Value_, arg1Value))) {
                    ...
                    this.state_ = state = state | 0b10000 /* add-active doObjectViaEnumeration(DynamicObject, long, boolean, JSHasPropertyNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doObjectViaEnumeration(arg0Value_, arg1Value, arg2Value, this.objectViaEnumeration_hasPropertyNode_);
                }
                if ((!(arg2Value)) && (!(isSuitableForEnumBasedProcessingUsingOwnKeys(arg0Value_, arg1Value))) && (JSArrayElementIndexNode.isSuitableForEnumBasedProcessing(arg0Value_, arg1Value))) {
                    ...
                    this.state_ = state = state | 0b100000 /* add-active doObjectViaFullEnumeration(DynamicObject, long, boolean, JSHasPropertyNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doObjectViaFullEnumeration(arg0Value_, arg1Value, arg2Value, this.objectViaFullEnumeration_hasPropertyNode_);
                }
    ...
    public Introspection getIntrospectionData() {
        ...
        if ((state & 0b100) != 0 /* is-active doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) */) {
            ...
            WithHolesCachedData s3_ = this.withHolesCached_cache;
            while (s3_ != null) {
                cached.add(Arrays.asList(s3_.cachedArrayType_, s3_.previousElementIndexNode_, s3_.isLengthMinusOne_));
                s3_ = s3_.next_;
            }
            s[2] = cached;
        } else if ((exclude & 0b10) != 0 /* is-excluded doWithHolesCached(DynamicObject, long, boolean, ScriptArray, JSArrayPreviousElementIndexNode, ConditionProfile) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
        ...
        if ((state & 0b1000) != 0 /* is-active doWithHolesUncached(DynamicObject, long, boolean, JSArrayPreviousElementIndexNode, ConditionProfile, ValueProfile) */) {
            ...
            WithHolesUncachedData s4_ = this.withHolesUncached_cache;
            if (s4_ != null) {
                cached.add(Arrays.asList(s4_.previousElementIndexNode_, s4_.isLengthMinusOne_, s4_.arrayTypeProfile_));
            }
            s[2] = cached;
        } else {
            s[1] = (byte)0b00 /* inactive */;
