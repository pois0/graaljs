...
public final class JSLeftShiftConstantNodeGen extends JSLeftShiftConstantNode implements Provider {
    ...
    public Object execute(VirtualFrame frameValue, Object operandNodeValue) {
        ...
        if ((state & 0b10000) != 0 /* is-active doGeneric(Object, JSToNumericNode, JSLeftShiftConstantNode) */) {
    ...
    public Object execute(VirtualFrame frameValue) {
        int state = state_;
        if ((state & 0b10110) == 0 /* only-active doInteger(int) */ && (state & 0b10111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doGeneric(Object, JSToNumericNode, JSLeftShiftConstantNode) */) {
            return execute_int0(frameValue, state);
        } else if ((state & 0b10011) == 0 /* only-active doDouble(double, JSToInt32Node) */ && (state & 0b10111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doGeneric(Object, JSToNumericNode, JSLeftShiftConstantNode) */) {
    ...
    private Object execute_double1(VirtualFrame frameValue, int state) {
        ...
        try {
            if ((state & 0b111000000) == 0 /* only-active 0:double */ && (state & 0b11111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doGeneric(Object, JSToNumericNode, JSLeftShiftConstantNode) */) {
            ...
            } else if ((state & 0b110100000) == 0 /* only-active 0:double */ && (state & 0b11111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doGeneric(Object, JSToNumericNode, JSLeftShiftConstantNode) */) {
                operandNodeValue_int = super.operandNode.executeInt(frameValue);
                operandNodeValue_ = JSTypes.intToDouble(operandNodeValue_int);
            } else if ((state & 0b101100000) == 0 /* only-active 0:double */ && (state & 0b11111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doGeneric(Object, JSToNumericNode, JSLeftShiftConstantNode) */) {
    ...
    public void executeVoid(VirtualFrame frameValue) {
        int state = state_;
        try {
            if ((state & 0b11000) == 0 /* only-active doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) */ && (state & 0b11111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doGeneric(Object, JSToNumericNode, JSLeftShiftConstantNode) */) {
                executeInt(frameValue);
                return;
            } else if ((state & 0b10111) != 0 /* is-active doInteger(int) || doSafeInteger(SafeInteger) || doDouble(double, JSToInt32Node) || doGeneric(Object, JSToNumericNode, JSLeftShiftConstantNode) */) {
                execute(frameValue);
                return;
            }
        } catch (UnexpectedResultException ex) {
    ...
    private Object executeAndSpecialize(Object operandNodeValue) {
        ...
        try {
            ...
            this.state_ = state = state | 0b10000 /* add-active doGeneric(Object, JSToNumericNode, JSLeftShiftConstantNode) */;
            lock.unlock();
            hasLock = false;
            return doGeneric(operandNodeValue, this.generic_leftToNumericNode_, this.generic_innerShiftNode_);
        } finally {
