...
public final class JSToIntegerAsLongNodeGen extends JSToIntegerAsLongNode implements Provider {
    ...
    public long executeLong(Object arg0Value) {
        ...
        if ((state & 0b11000) != 0 /* is-active doDouble(double) || doDoubleInfinite(double) */ && JSTypesGen.isImplicitDouble((state & 0b111100000000000) >>> 11 /* extract-implicit-active 0:double */, arg0Value)) {
        ...
        if ((state & 0b1000000000) != 0 /* is-active doString(String, JSToIntegerAsLongNode, JSStringToNumberNode) */ && JSTypesGen.isImplicitString((state & 0x78000) >>> 15 /* extract-implicit-active 0:String */, arg0Value)) {
        ...
        if ((state & 0b10000000000) != 0 /* is-active doJSObject(DynamicObject, JSToNumberNode) */ && JSTypes.isDynamicObject(arg0Value)) {
        ...
        try {
            ...
            }
            {
                ...
                if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(arg0Value)) != 0) {
                    ...
                    if ((Double.isInfinite(arg0Value_))) {
                        state = (state | (doubleCast0 << 11) /* set-implicit-active 0:double */);
                        this.state_ = state = state | 0b10000 /* add-active doDoubleInfinite(double) */;
                        lock.unlock();
                        hasLock = false;
                        return JSToIntegerAsLongNode.doDoubleInfinite(arg0Value_);
                    }
            ...
            if ((JSGuards.isJSNull(arg0Value))) {
                this.state_ = state = state | 0b1000000 /* add-active doNull(Object) */;
                lock.unlock();
                hasLock = false;
                return JSToIntegerAsLongNode.doNull(arg0Value);
            }
            ...
            }
            {
                ...
                if ((stringCast0 = JSTypesGen.specializeImplicitString(arg0Value)) != 0) {
                    ...
                    this.state_ = state = state | 0b1000000000 /* add-active doString(String, JSToIntegerAsLongNode, JSStringToNumberNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doString(arg0Value_, this.string_nestedToIntegerNode_, this.string_stringToNumberNode_);
                }
            ...
            if (JSTypes.isDynamicObject(arg0Value)) {
                ...
                if ((JSGuards.isJSObject(arg0Value_))) {
                    ...
                    this.state_ = state = state | 0b10000000000 /* add-active doJSObject(DynamicObject, JSToNumberNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doJSObject(arg0Value_, this.jSObject_toNumberNode_);
                }
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "doString";
        if ((state & 0b1000000000) != 0 /* is-active doString(String, JSToIntegerAsLongNode, JSStringToNumberNode) */) {
            s[1] = (byte)0b01 /* active */;
        ...
        s = new Object[3];
        s[0] = "doJSObject";
        if ((state & 0b10000000000) != 0 /* is-active doJSObject(DynamicObject, JSToNumberNode) */) {
            s[1] = (byte)0b01 /* active */;
            ArrayList<Object> cached = new ArrayList<>();
