...
public final class JSToNumberNodeGen extends JSToNumberNode implements Provider {
    ...
    public Object execute(Object arg0Value) {
        ...
        if ((state & 0b11000) != 0 /* is-active doNull(Object) || doUndefined(Object) */) {
            if ((state & 0b1000) != 0 /* is-active doNull(Object) */) {
                if ((JSGuards.isJSNull(arg0Value))) {
                    return JSToNumberNode.doNull(arg0Value);
                }
            }
            if ((state & 0b10000) != 0 /* is-active doUndefined(Object) */) {
                if ((JSGuards.isUndefined(arg0Value))) {
                    return JSToNumberNode.doUndefined(arg0Value);
                }
            }
        }
        if ((state & 0b100000) != 0 /* is-active doString(String) */ && JSTypesGen.isImplicitString((state & 0x78000) >>> 15 /* extract-implicit-active 0:String */, arg0Value)) {
        ...
        if ((state & 0b1000000) != 0 /* is-active doJSObject(DynamicObject, JSToPrimitiveNode) */ && JSTypes.isDynamicObject(arg0Value)) {
        ...
        if ((state & 0b11000000000) != 0 /* is-active doForeignObject(Object, JSToPrimitiveNode) || doJavaObject(Object) */) {
            ...
            if ((state & 0b10000000000) != 0 /* is-active doJavaObject(Object) */) {
    ...
    private Object executeAndSpecialize(Object arg0Value) {
        ...
        try {
            ...
            if ((JSGuards.isUndefined(arg0Value))) {
                this.state_ = state = state | 0b10000 /* add-active doUndefined(Object) */;
                lock.unlock();
                hasLock = false;
                return JSToNumberNode.doUndefined(arg0Value);
            }
            ...
            if (JSTypes.isDynamicObject(arg0Value)) {
                ...
                if ((JSGuards.isJSObject(arg0Value_))) {
                    ...
                    this.state_ = state = state | 0b1000000 /* add-active doJSObject(DynamicObject, JSToPrimitiveNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doJSObject(arg0Value_, this.jSObject_toPrimitiveNode_);
                }
            ...
            if ((JSGuards.isJavaNumber(arg0Value))) {
                this.state_ = state = state | 0b10000000000 /* add-active doJavaObject(Object) */;
                lock.unlock();
                hasLock = false;
                return JSToNumberNode.doJavaObject(arg0Value);
            }
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "doJSObject";
        if ((state & 0b1000000) != 0 /* is-active doJSObject(DynamicObject, JSToPrimitiveNode) */) {
            s[1] = (byte)0b01 /* active */;
    ...
    public static final class JSToNumberUnaryNodeGen extends JSToNumberUnaryNode implements Provider {
