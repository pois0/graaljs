...
public final class JSRightShiftNodeGen extends JSRightShiftNode implements Provider {
    ...
    public Object execute(Object leftNodeValue, Object rightNodeValue) {
        ...
        if ((state & 0b10) != 0 /* is-active doBigInt(BigInt, BigInt, JSLeftShiftNode) */ && leftNodeValue instanceof BigInt) {
        ...
        if ((state & 0b1100) != 0 /* is-active doIntDouble(int, double) || doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */ && JSTypesGen.isImplicitDouble((state & 0b111100000) >>> 5 /* extract-implicit-active 1:double */, rightNodeValue)) {
            double rightNodeValue_ = JSTypesGen.asImplicitDouble((state & 0b111100000) >>> 5 /* extract-implicit-active 1:double */, rightNodeValue);
            if ((state & 0b100) != 0 /* is-active doIntDouble(int, double) */ && leftNodeValue instanceof Integer) {
                int leftNodeValue_ = (int) leftNodeValue;
                if ((!(JSBinaryNode.largerThan2e32(rightNodeValue_)))) {
                    return doIntDouble(leftNodeValue_, rightNodeValue_);
                }
            }
            if ((state & 0b1000) != 0 /* is-active doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */ && JSTypesGen.isImplicitDouble((state & 0b1111000000000) >>> 9 /* extract-implicit-active 0:double */, leftNodeValue)) {
                ...
                if (s4_ != null) {
                    return doDouble(leftNodeValue_, rightNodeValue_, s4_.rightShift_, s4_.leftInt32_, s4_.rightUInt32_);
                }
            }
        }
        if ((state & 0b10000) != 0 /* is-active doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
    ...
    public Object execute(VirtualFrame frameValue) {
        int state = state_;
        if ((state & 0b11110) == 0 /* only-active doInteger(int, int) */ && (state & 0b11111) != 0  /* is-not doInteger(int, int) && doBigInt(BigInt, BigInt, JSLeftShiftNode) && doIntDouble(int, double) && doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) && doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
            return execute_int_int0(frameValue, state);
        } else if ((state & 0b11011) == 0 /* only-active doIntDouble(int, double) */ && (state & 0b11111) != 0  /* is-not doInteger(int, int) && doBigInt(BigInt, BigInt, JSLeftShiftNode) && doIntDouble(int, double) && doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) && doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
            return execute_int_double1(frameValue, state);
        } else if ((state & 0b10111) == 0 /* only-active doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */ && (state & 0b11111) != 0  /* is-not doInteger(int, int) && doBigInt(BigInt, BigInt, JSLeftShiftNode) && doIntDouble(int, double) && doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) && doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
    ...
    private Object execute_int_double1(VirtualFrame frameValue, int state) {
        ...
        try {
            if ((state & 0b111000000) == 0 /* only-active 1:double */ && (state & 0b11111) != 0  /* is-not doInteger(int, int) && doBigInt(BigInt, BigInt, JSLeftShiftNode) && doIntDouble(int, double) && doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) && doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
                rightNodeValue_long = super.rightNode.executeLong(frameValue);
                rightNodeValue_ = JSTypes.longToDouble(rightNodeValue_long);
            } else if ((state & 0b110100000) == 0 /* only-active 1:double */ && (state & 0b11111) != 0  /* is-not doInteger(int, int) && doBigInt(BigInt, BigInt, JSLeftShiftNode) && doIntDouble(int, double) && doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) && doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
                rightNodeValue_int = super.rightNode.executeInt(frameValue);
                rightNodeValue_ = JSTypes.intToDouble(rightNodeValue_int);
            } else if ((state & 0b101100000) == 0 /* only-active 1:double */ && (state & 0b11111) != 0  /* is-not doInteger(int, int) && doBigInt(BigInt, BigInt, JSLeftShiftNode) && doIntDouble(int, double) && doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) && doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
        ...
        assert (state & 0b100) != 0 /* is-active doIntDouble(int, double) */;
        if ((!(JSBinaryNode.largerThan2e32(rightNodeValue_)))) {
            return doIntDouble(leftNodeValue_, rightNodeValue_);
        }
        CompilerDirectives.transferToInterpreterAndInvalidate();
    ...
    private Object execute_double_double2(VirtualFrame frameValue, int state) {
        ...
        try {
            ...
            } else if ((state & 0b1101000000000) == 0 /* only-active 0:double */ && (state & 0b11111) != 0  /* is-not doInteger(int, int) && doBigInt(BigInt, BigInt, JSLeftShiftNode) && doIntDouble(int, double) && doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) && doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
                leftNodeValue_int = super.leftNode.executeInt(frameValue);
                leftNodeValue_ = JSTypes.intToDouble(leftNodeValue_int);
            } else if ((state & 0b1011000000000) == 0 /* only-active 0:double */ && (state & 0b11111) != 0  /* is-not doInteger(int, int) && doBigInt(BigInt, BigInt, JSLeftShiftNode) && doIntDouble(int, double) && doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) && doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
        ...
        assert (state & 0b1000) != 0 /* is-active doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */;
        DoubleData s4_ = this.double_cache;
        if (s4_ != null) {
            return doDouble(leftNodeValue_, rightNodeValue_, s4_.rightShift_, s4_.leftInt32_, s4_.rightUInt32_);
        }
    ...
    private Object execute_generic3(VirtualFrame frameValue, int state) {
        ...
        if ((state & 0b10) != 0 /* is-active doBigInt(BigInt, BigInt, JSLeftShiftNode) */ && leftNodeValue_ instanceof BigInt) {
        ...
        if ((state & 0b1100) != 0 /* is-active doIntDouble(int, double) || doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */ && JSTypesGen.isImplicitDouble((state & 0b111100000) >>> 5 /* extract-implicit-active 1:double */, rightNodeValue_)) {
            double rightNodeValue__ = JSTypesGen.asImplicitDouble((state & 0b111100000) >>> 5 /* extract-implicit-active 1:double */, rightNodeValue_);
            if ((state & 0b100) != 0 /* is-active doIntDouble(int, double) */ && leftNodeValue_ instanceof Integer) {
                int leftNodeValue__ = (int) leftNodeValue_;
                if ((!(JSBinaryNode.largerThan2e32(rightNodeValue__)))) {
                    return doIntDouble(leftNodeValue__, rightNodeValue__);
                }
            }
            if ((state & 0b1000) != 0 /* is-active doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */ && JSTypesGen.isImplicitDouble((state & 0b1111000000000) >>> 9 /* extract-implicit-active 0:double */, leftNodeValue_)) {
                ...
                DoubleData s4_ = this.double_cache;
                if (s4_ != null) {
                    return doDouble(leftNodeValue__, rightNodeValue__, s4_.rightShift_, s4_.leftInt32_, s4_.rightUInt32_);
                }
            }
        }
        if ((state & 0b10000) != 0 /* is-active doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
    ...
    public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
        int state = state_;
        if ((state & 0b11000) != 0 /* is-active doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) || doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
        ...
        if ((state & 0b100) == 0 /* only-active doInteger(int, int) */ && (state & 0b101) != 0  /* is-not doInteger(int, int) && doIntDouble(int, double) */) {
            return executeInt_int4(frameValue, state, leftNodeValue_);
        } else if ((state & 0b1) == 0 /* only-active doIntDouble(int, double) */ && (state & 0b101) != 0  /* is-not doInteger(int, int) && doIntDouble(int, double) */) {
    ...
    private int executeInt_generic6(VirtualFrame frameValue, int state, int leftNodeValue_) throws UnexpectedResultException {
        ...
        if ((state & 0b100) != 0 /* is-active doIntDouble(int, double) */ && JSTypesGen.isImplicitDouble((state & 0b111100000) >>> 5 /* extract-implicit-active 1:double */, rightNodeValue_)) {
            double rightNodeValue__ = JSTypesGen.asImplicitDouble((state & 0b111100000) >>> 5 /* extract-implicit-active 1:double */, rightNodeValue_);
            if ((!(JSBinaryNode.largerThan2e32(rightNodeValue__)))) {
    ...
    public void executeVoid(VirtualFrame frameValue) {
        int state = state_;
        try {
            if ((state & 0b11010) == 0 /* only-active doInteger(int, int) && doIntDouble(int, double) */ && (state & 0b11111) != 0  /* is-not doInteger(int, int) && doBigInt(BigInt, BigInt, JSLeftShiftNode) && doIntDouble(int, double) && doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) && doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            if (((exclude & 0b10)) == 0 /* is-not-excluded doBigInt(BigInt, BigInt, JSLeftShiftNode) */ && leftNodeValue instanceof BigInt) {
                BigInt leftNodeValue_ = (BigInt) leftNodeValue;
                if (rightNodeValue instanceof BigInt) {
                    BigInt rightNodeValue_ = (BigInt) rightNodeValue;
                    this.bigInt_leftShift_ = super.insert((JSLeftShiftNode.create()));
                    this.state_ = state = state | 0b10 /* add-active doBigInt(BigInt, BigInt, JSLeftShiftNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doBigInt(leftNodeValue_, rightNodeValue_, this.bigInt_leftShift_);
                }
            }
            {
                ...
                if ((doubleCast1 = JSTypesGen.specializeImplicitDouble(rightNodeValue)) != 0) {
                    ...
                    if (((exclude & 0b100)) == 0 /* is-not-excluded doIntDouble(int, double) */ && leftNodeValue instanceof Integer) {
                        int leftNodeValue_ = (int) leftNodeValue;
                        if ((!(JSBinaryNode.largerThan2e32(rightNodeValue_)))) {
                            state = (state | (doubleCast1 << 5) /* set-implicit-active 1:double */);
                            this.state_ = state = state | 0b100 /* add-active doIntDouble(int, double) */;
                            lock.unlock();
                            hasLock = false;
                            return doIntDouble(leftNodeValue_, rightNodeValue_);
                        }
                    }
                    if (((exclude & 0b1000)) == 0 /* is-not-excluded doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */) {
                        int doubleCast0;
                        if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(leftNodeValue)) != 0) {
                            ...
                            state = (state | (doubleCast1 << 5) /* set-implicit-active 1:double */);
                            this.state_ = state = state | 0b1000 /* add-active doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */;
                            lock.unlock();
                            hasLock = false;
                            return doDouble(leftNodeValue_, rightNodeValue_, s4_.rightShift_, s4_.leftInt32_, s4_.rightUInt32_);
                        }
            ...
            this.exclude_ = exclude = exclude | 0b1111 /* add-excluded doInteger(int, int), doBigInt(BigInt, BigInt, JSLeftShiftNode), doIntDouble(int, double), doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */;
            this.double_cache = null;
            state = state & 0xfffffff0 /* remove-active doInteger(int, int), doBigInt(BigInt, BigInt, JSLeftShiftNode), doIntDouble(int, double), doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */;
            this.state_ = state = state | 0b10000 /* add-active doGeneric(Object, Object, JSRightShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */;
            lock.unlock();
            hasLock = false;
            return doGeneric(leftNodeValue, rightNodeValue, s5_.rightShift_, s5_.leftToNumeric_, s5_.rightToNumeric_, s5_.mixedNumericTypes_);
        } finally {
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "doBigInt";
        if ((state & 0b10) != 0 /* is-active doBigInt(BigInt, BigInt, JSLeftShiftNode) */) {
            s[1] = (byte)0b01 /* active */;
            ArrayList<Object> cached = new ArrayList<>();
            cached.add(Arrays.asList(this.bigInt_leftShift_));
            s[2] = cached;
        } else if ((exclude & 0b10) != 0 /* is-excluded doBigInt(BigInt, BigInt, JSLeftShiftNode) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
        ...
        s = new Object[3];
        s[0] = "doIntDouble";
        if ((state & 0b100) != 0 /* is-active doIntDouble(int, double) */) {
            s[1] = (byte)0b01 /* active */;
        } else if ((exclude & 0b100) != 0 /* is-excluded doIntDouble(int, double) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
        ...
        s = new Object[3];
        s[0] = "doDouble";
        if ((state & 0b1000) != 0 /* is-active doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */) {
            s[1] = (byte)0b01 /* active */;
            ArrayList<Object> cached = new ArrayList<>();
            DoubleData s4_ = this.double_cache;
            if (s4_ != null) {
            ...
            s[2] = cached;
        } else if ((exclude & 0b1000) != 0 /* is-excluded doDouble(double, double, JSRightShiftNode, JSToInt32Node, JSToUInt32Node) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
